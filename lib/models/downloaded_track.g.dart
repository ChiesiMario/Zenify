...
const DownloadedTrackSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'isManualDownload': PropertySchema(
      id: 7,
      name: r'isManualDownload',
      type: IsarType.bool,
    ),
...
void _downloadedTrackSerialize(
  ...
  writer.writeBool(offsets[7], object.isManualDownload);
  writer.writeString(offsets[8], object.localPath);
  writer.writeString(offsets[9], object.rawData);
...
DownloadedTrack _downloadedTrackDeserialize(
  ...
  object.isManualDownload = reader.readBool(offsets[7]);
  object.localPath = reader.readString(offsets[8]);
  object.rawData = reader.readString(offsets[9]);
  object.serverId = reader.readLong(offsets[10]);
  object.sizeBytes = reader.readLong(offsets[11]);
  object.songId = reader.readString(offsets[12]);
...
extension DownloadedTrackQueryFilter
  ...
  QueryBuilder<DownloadedTrack, DownloadedTrack, QAfterFilterCondition>
      isManualDownloadEqualTo(bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'isManualDownload',
        value: value,
      ));
    });
  }
...
extension DownloadedTrackQuerySortBy
  ...
  QueryBuilder<DownloadedTrack, DownloadedTrack, QAfterSortBy>
      sortByIsManualDownload() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isManualDownload', Sort.asc);
    });
  }

  QueryBuilder<DownloadedTrack, DownloadedTrack, QAfterSortBy>
      sortByIsManualDownloadDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isManualDownload', Sort.desc);
    });
  }
...
extension DownloadedTrackQueryWhereDistinct
  ...
  QueryBuilder<DownloadedTrack, DownloadedTrack, QDistinct>
      distinctByIsManualDownload() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'isManualDownload');
    });
  }
...
extension DownloadedTrackQueryProperty
  ...
  QueryBuilder<DownloadedTrack, bool, QQueryOperations>
      isManualDownloadProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isManualDownload');
    });
  }
