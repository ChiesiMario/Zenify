...
Server _serverDeserialize(
  ...
  object.version = reader.readStringOrNull(offsets[4]);
  return object;
}
...
extension ServerQueryFilter on QueryBuilder<Server, Server, QFilterCondition> {
  ...
  QueryBuilder<Server, Server, QAfterFilterCondition> isActiveEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'isActive',
  ...
  QueryBuilder<Server, Server, QAfterFilterCondition> usernameEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Server, Server, QAfterFilterCondition> usernameGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Server, Server, QAfterFilterCondition> usernameLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Server, Server, QAfterFilterCondition> usernameBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Server, Server, QAfterFilterCondition> usernameStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Server, Server, QAfterFilterCondition> usernameEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Server, Server, QAfterFilterCondition> usernameContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<Server, Server, QAfterFilterCondition> usernameMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<Server, Server, QAfterFilterCondition> usernameIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'username',
        value: '',
  ...
  QueryBuilder<Server, Server, QAfterFilterCondition> usernameIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'username',
        value: '',
  ...
  QueryBuilder<Server, Server, QAfterFilterCondition> versionIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Server, Server, QAfterFilterCondition> versionIsNotNull() {
    return QueryBuilder.apply(this, (query) {
...
extension ServerQuerySortBy on QueryBuilder<Server, Server, QSortBy> {
  QueryBuilder<Server, Server, QAfterSortBy> sortByIsActive() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isActive', Sort.asc);
    });
  }

  QueryBuilder<Server, Server, QAfterSortBy> sortByIsActiveDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Server, Server, QAfterSortBy> sortByUsername() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'username', Sort.asc);
    });
  }

  QueryBuilder<Server, Server, QAfterSortBy> sortByUsernameDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ServerQuerySortThenBy on QueryBuilder<Server, Server, QSortThenBy> {
  ...
  QueryBuilder<Server, Server, QAfterSortBy> thenByIsActive() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isActive', Sort.asc);
    });
  }

  QueryBuilder<Server, Server, QAfterSortBy> thenByIsActiveDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isActive', Sort.desc);
    });
  }
  ...
  QueryBuilder<Server, Server, QAfterSortBy> thenByUsername() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'username', Sort.asc);
    });
  }

  QueryBuilder<Server, Server, QAfterSortBy> thenByUsernameDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'username', Sort.desc);
    });
  }
...
extension ServerQueryWhereDistinct on QueryBuilder<Server, Server, QDistinct> {
  QueryBuilder<Server, Server, QDistinct> distinctByIsActive() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Server, Server, QDistinct> distinctByUsername(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension ServerQueryProperty on QueryBuilder<Server, Server, QQueryProperty> {
  ...
  QueryBuilder<Server, bool, QQueryOperations> isActiveProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Server, String, QQueryOperations> usernameProperty() {
    return QueryBuilder.apply(this, (query) {
